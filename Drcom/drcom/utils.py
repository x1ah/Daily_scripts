...
class HTTPRequest:
    """
    get(url, timeout=20, **args) ->
        return requests.get(url, timeout, headers.update(args))

    post(url, timeout=20, **args) ->
        return requests.post(url, timeout, headers.update(args))
    """
    ...
    def __init__(self, **args):
        """
        :params args: some args you want update in headers
        """
        self.session.headers.update(args)

    def get(self, url, timeout=20, **args):
        return self.session.get(url, timeout=timeout, **args)

    def post(self, url, timeout=20, **args):
...
class Base(object):
    def __init__(self, **args):
        ...
        # self.logger = create_logger("drcom.log")
